...
CHEMISTRY = DisciplineConfig(
    ...
    venues=[
        ...
        "Angewandte Chemie", "Nature Chemistry", "Nature",
    ...
    correctness_categories=[
        ...
        "Stoichiometry and Mass Balance Errors - Reaction equations that are not balanced, "
        "incorrect molar ratios",
        "Spectroscopic Data Inconsistencies - NMR, MS, or IR data that contradicts the "
        "proposed structure",
        "Thermodynamic/Kinetic Errors - Incorrect application of thermodynamic principles, "
        "invalid kinetic models",
