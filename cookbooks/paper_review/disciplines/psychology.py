...
PSYCHOLOGY = DisciplineConfig(
    ...
    venues=[
        "Psychological Science", "Journal of Personality and Social Psychology (JPSP)",
        "Psychological Review", "Cognition", "Journal of Experimental Psychology: General",
        "Perspectives on Psychological Science", "Annual Review of Psychology",
        "Nature Human Behaviour", "Trends in Cognitive Sciences",
        "Journal of Cognitive Neuroscience", "Psychonomic Bulletin & Review",
    ],
    reviewer_context=(
    ...
    correctness_categories=[
        ...
        "Data Inconsistencies - Sample sizes, means, or statistics that differ between text, "
        "tables, and figures",
