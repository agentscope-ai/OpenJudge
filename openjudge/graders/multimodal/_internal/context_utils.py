...
def get_image_context(
    ...
    if context_above and max_context_size is not None and len(context_above) > max_context_size:
    ...
    if context_below and max_context_size is not None and len(context_below) > max_context_size:
